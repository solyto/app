...
const libraries: LibraryRecords = {
	...
	books: {
		...
		author_hardcover_id: 'Hardcover-ID',
		author_resync: 'Von Hardcover importieren / abgleichen',
		author_resync_success: 'Autor*in mit Hardcover abgeglichen.',
		author_resync_error: 'Abgleich mit Hardcover fehlgeschlagen.',
		author_books: 'Bücher',
		author_no_books: 'Noch keine Bücher verknüpft.',
		author_no_authors: 'Noch keine Autor*innen. Füge eine im Bibliothekskopf hinzu oder verknüpfe eine beim Erstellen eines Buchs.',
		author_all: 'Alle',
		author_favorites_only: 'Favoriten',
		author_unlink: 'Verknüpfung lösen',
		author_unlink_error: 'Verknüpfung konnte nicht gelöst werden.',
		author_create_error: 'Autor*in konnte nicht erstellt werden.',
		author_update_error: 'Autor*in konnte nicht aktualisiert werden.',
		author_photo_error: 'Foto konnte nicht hochgeladen werden.',
		author_delete_confirm_title: 'Autor*in löschen',
		author_delete_confirm_description: 'Dadurch werden verknüpfte Bücher entknüpft, ihr Autor-Text bleibt aber unverändert. Dies kann nicht rückgängig gemacht werden.'
	},
	movies: {
		title: 'Titel',
		category: 'Kategorie',
