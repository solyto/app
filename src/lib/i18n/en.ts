...
const libraries: LibraryRecords = {
	...
	books: {
		...
		author_resync: 'Import / Re-sync from Hardcover',
		author_resync_success: 'Author synced from Hardcover.',
		author_resync_error: 'Failed to sync from Hardcover.',
		author_books: 'Books',
		author_no_books: 'No books linked yet.',
		author_no_authors: 'No authors yet. Add one from the library header or link one while creating a book.',
		author_all: 'All',
		author_favorites_only: 'Favorites',
		author_unlink: 'Unlink',
		author_unlink_error: 'Failed to unlink book.',
		author_create_error: 'Failed to create author.',
		author_update_error: 'Failed to update author.',
		author_photo_error: 'Failed to upload photo.',
		author_delete_confirm_title: 'Delete Author',
		author_delete_confirm_description: 'This unlinks their books but keeps each book’s author text as-is. This cannot be undone.'
	},
	movies: {
		title: 'Title',
		category: 'Category',
