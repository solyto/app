...
const libraries: LibraryRecords = {
	...
	books: {
		...
		author_hardcover_id: 'ID Hardcover',
		author_resync: 'Importer / resynchroniser depuis Hardcover',
		author_resync_success: 'Auteur synchronisé depuis Hardcover.',
		author_resync_error: 'Échec de la synchronisation avec Hardcover.',
		author_books: 'Livres',
		author_no_books: 'Aucun livre lié pour le moment.',
		author_no_authors: 'Aucun auteur pour le moment. Ajoutez-en un depuis l\'en-tête de la bibliothèque ou liez-en un lors de la création d\'un livre.',
		author_all: 'Tous',
		author_favorites_only: 'Favoris',
		author_unlink: 'Délier',
		author_unlink_error: 'Impossible de délier le livre.',
		author_create_error: 'Impossible de créer l\'auteur.',
		author_update_error: 'Impossible de modifier l\'auteur.',
		author_photo_error: 'Impossible de téléverser la photo.',
		author_delete_confirm_title: 'Supprimer l\'auteur',
		author_delete_confirm_description: 'Cela délie ses livres, mais conserve le texte de l\'auteur de chaque livre tel quel. Cette action est irréversible.'
	},
	movies: {
		title: 'Titre',
		category: 'Catégorie',
	...
	recipes: {
		...
		kcal_per_serving: 'kcal par portion',
		servings: 'Portions',
		portions: 'Portions',
		cover: 'URL de l\'image',
		link: 'Lien',
